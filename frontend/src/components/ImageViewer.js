...
const Image = (props) => {
	...
	return (<div style={{ width, height, ...style }} {...otherProps} className="flex justify-content-center align-items-center text-center surface-100 p-2">
			{imgTag}
		</div>);
}
		...
		return (
			<div className="flex">
				{images.map((img, index) => {
					if (index < numDisplay) {
						return (
							<div className="mr-2 flex-1" key={index}>
